<template>
    <div class="m-1 py-[25px] px-[20px] border border-[#EAEAEA] rounded-[10px] hover:border-[#DB77DB] transition ease-in">
        ...
        <div class="mt-[4px]">
            ...
            <div class="bg-[#F4F4F5] text-[7px] py-1 px-2 w-fit rounded-[11px] text-[#6D6D6D] font-bold">REFERRAL CODE: {{ contribution.referralCode }} <br> REFERRAL COUNT: {{ contribution.referralCount }}</div>
        </div>
        <div @click="copyReferralCode" class="w-fit mt-3 text-[14px] flex gap-1 items-center hover:underline cursor-pointer">
            <svg v-if="!referralCodeCopied" width="20px" height="20px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M8.5 4H6C4.89543 4 4 4.89543 4 6V20C4 21.1046 4.89543 22 6 22H18C19.1046 22 20 21.1046 20 20V6C20 4.89543 19.1046 4 18 4H15.5" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path><path d="M8 6.4V4.5C8 4.22386 8.22386 4 8.5 4C8.77614 4 9.00422 3.77604 9.05152 3.50398C9.19968 2.65171 9.77399 1 12 1C14.226 1 14.8003 2.65171 14.9485 3.50398C14.9958 3.77604 15.2239 4 15.5 4C15.7761 4 16 4.22386 16 4.5V6.4C16 6.73137 15.7314 7 15.4 7H8.6C8.26863 7 8 6.73137 8 6.4Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path></svg>
            <svg v-else width="24px" height="24px" viewBox="0 0 24 24" stroke-width="1.5" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M8.5 4H6C4.89543 4 4 4.89543 4 6V20C4 21.1046 4.89543 22 6 22H12" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path><path d="M15.5 4H18C19.1046 4 20 4.89543 20 6V15" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path><path d="M8 6.4V4.5C8 4.22386 8.22386 4 8.5 4C8.77614 4 9.00422 3.77604 9.05152 3.50398C9.19968 2.65171 9.77399 1 12 1C14.226 1 14.8003 2.65171 14.9485 3.50398C14.9958 3.77604 15.2239 4 15.5 4C15.7761 4 16 4.22386 16 4.5V6.4C16 6.73137 15.7314 7 15.4 7H8.6C8.26863 7 8 6.73137 8 6.4Z" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path><path d="M15.5 20.5L17.5 22.5L22.5 17.5" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
            {{ referralCodeCopied ? 'Copied' : 'Copy referral code' }}
        </div>
...
function copyReferralCode() {
  if (props.contribution.referralCode) {
    navigator.clipboard.writeText(props.contribution.referralCode)
      ...
      setTimeout(() => {
        referralCodeCopied.value = false
      }, 4000);
  }
}
</script>